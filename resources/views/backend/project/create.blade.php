...
<div class="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <form action="{{ route('store_project') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            {{-- Category with Dropdown Checkboxes (Fixed Version) --}}
            <div class="relative">
                <label class="block text-sm font-medium text-gray-700">Kategori</label>
                <div x-data="{ open: false, selectedIds: [], selectedNames: [] }" class="mt-1 relative">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" rows="4"
                    class="mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:ring focus:ring-blue-500 focus:border-blue-500"></textarea>
            </div>
            ...
            <div x-data="{ imagePreview: null }" class="md:col-span-2">
                ...
                if (file) {
                    ...
                    <span class="text-sm text-gray-500 z-0" x-show="!imagePreview">Klik atau seret gambar</span>

                    {{-- Preview gambar langsung dalam kotak --}}
